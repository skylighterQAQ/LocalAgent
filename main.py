#!/usr/bin/env python3
"""
LocalAgent - Local AI Agent powered by Ollama + LangGraph
...
def main():
    ...
    load_skills(cfg.skills)
    registry = get_registry()
    skills_info = registry.list_skills()

    if args.list_skills:
        from ui.cli import print_skills_table
        from rich.console import Console
        Console().print(f"\nRegistered skills ({len(skills_info)}):")
    ...
    if args.task:
        ...
        run_interactive(graph, cfg.ollama.model, skills_info)
